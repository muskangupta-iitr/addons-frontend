...
// localized.
errorData.messages.push(message)})}else if("code"===key){errorData.code=value}else if("is_disabled_by_developer"===key){if(!0===value){var newCode=core_constants["C" /* ERROR_ADDON_DISABLED_BY_DEV */];logCodeChange({oldCode:errorData.code,newCode:newCode});errorData.code=newCode}}else if("is_disabled_by_mozilla"===key){if(!0===value){var _newCode=core_constants["B" /* ERROR_ADDON_DISABLED_BY_ADMIN */];logCodeChange({oldCode:errorData.code,newCode:_newCode});errorData.code=_newCode}}else if("string"==typeof value||"object"===_typeof(value)){// This is a catch-all for errors that are not structured like
...
// };
//
var errors_initialState={};function errors(){var state=0<arguments.length&&arguments[0]!==void 0?arguments[0]:errors_initialState,action=1<arguments.length?arguments[1]:void 0;switch(action.type){case core_constants["p" /* CLEAR_ERROR */]:return errors_objectSpread({},state,errors_defineProperty({},action.payload.id,null));case core_constants["Db" /* SET_ERROR */]:{var _getMessagesFromError=getMessagesFromError(action.payload.error),code=_getMessagesFromError.code,messages=_getMessagesFromError.messages;return errors_objectSpread({},state,errors_defineProperty({},action.payload.id,{code:code,messages:messages,responseStatusCode:action.payload.error.response?action.payload.error.response.status:null}))}case core_constants["Eb" /* SET_ERROR_MESSAGE */]:{var errorData=state[action.payload.id]||{messages:[]};errorData.messages.push(action.payload.message);return errors_objectSpread({},state,errors_defineProperty({},action.payload.id,errorData))}default:return state;}}
...
function installations_ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function installations_objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){installations_ownKeys(Object(source),!0).forEach(function(key){installations_defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{installations_ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function installations_defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0})}else{obj[key]=value}return obj}function installations(){var state=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},_ref=1<arguments.length?arguments[1]:void 0,type=_ref.type,payload=_ref.payload;function updateAddon(newProps){var guid=payload.guid,addon=state[guid];if(!addon){throw new Error("Cannot reduce type ".concat(type,"; no add-on with guid ").concat(guid," found."))}return installations_objectSpread({},addon,{},newProps)}switch(type){case core_constants["mb" /* INSTALL_STATE */]:return installations_objectSpread({},state,installations_defineProperty({},payload.guid,{guid:payload.guid,url:payload.url,error:payload.error,downloadProgress:0,status:payload.status,needsRestart:payload.needsRestart||!1}));case core_constants["Jb" /* START_DOWNLOAD */]:return installations_objectSpread({},state,installations_defineProperty({},payload.guid,updateAddon({status:core_constants["t" /* DOWNLOADING */]})));case core_constants["v" /* DOWNLOAD_PROGRESS */]:return installations_objectSpread({},state,installations_defineProperty({},payload.guid,updateAddon({downloadProgress:payload.downloadProgress})));case core_constants["bb" /* INSTALL_COMPLETE */]:return installations_objectSpread({},state,installations_defineProperty({},payload.guid,updateAddon({status:core_constants["U" /* INSTALLED */]})));case core_constants["Wb" /* UNINSTALL_COMPLETE */]:return installations_objectSpread({},state,installations_defineProperty({},payload.guid,updateAddon({status:core_constants["Tb" /* UNINSTALLED */]})));case core_constants["X" /* INSTALL_CANCELLED */]:return installations_objectSpread({},state,installations_defineProperty({},payload.guid,updateAddon({downloadProgress:0,status:core_constants["Tb" /* UNINSTALLED */]})));case core_constants["fb" /* INSTALL_ERROR */]:return installations_objectSpread({},state,installations_defineProperty({},payload.guid,updateAddon({downloadProgress:0,error:payload.error,status:core_constants["A" /* ERROR */]})));default:return state;}}
...
function setAuthToken(token){if(!token){throw new Error("token cannot be falsey")}return{type:core_constants["Ab" /* SET_AUTH_TOKEN */],payload:{token:token}}}function setClientApp(clientApp){if(!clientApp){throw new Error("clientApp cannot be falsey")}return{type:core_constants["Bb" /* SET_CLIENT_APP */],payload:{clientApp:clientApp}}}function setLang(lang){return{type:core_constants["Fb" /* SET_LANG */],payload:{lang:lang}}}function setUserAgent(userAgent){return{type:core_constants["Hb" /* SET_USER_AGENT */],payload:{userAgent:userAgent}}}function setRequestId(requestId){return{type:core_constants["Gb" /* SET_REQUEST_ID */],payload:{requestId:requestId}}}
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return DOWNLOADING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return ENABLED; });
/* unused harmony export ENABLING */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return ERROR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "K", function() { return INACTIVE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "U", function() { return INSTALLED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "V", function() { return INSTALLING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Tb", function() { return UNINSTALLED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Ub", function() { return UNINSTALLING; });
/* unused harmony export UNKNOWN */
/* unused harmony export validInstallStates */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return DOWNLOAD_FAILED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "X", function() { return INSTALL_CANCELLED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ib", function() { return INSTALL_FAILED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return ERROR_CORRUPT_FILE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "G", function() { return FATAL_INSTALL_ERROR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "H", function() { return FATAL_UNINSTALL_ERROR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "F", function() { return FATAL_ERROR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return CLIENT_APP_ANDROID; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return CLIENT_APP_FIREFOX; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bc", function() { return validAddonTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return API_ADDON_TYPES_MAPPING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ac", function() { return VISIBLE_ADDON_TYPES_MAPPING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "N", function() { return INCOMPATIBLE_FIREFOX_FOR_IOS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "R", function() { return INCOMPATIBLE_OVER_MAX_VERSION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return INCOMPATIBLE_NO_OPENSEARCH; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return INCOMPATIBLE_NOT_FIREFOX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "S", function() { return INCOMPATIBLE_UNDER_MIN_VERSION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "T", function() { return INCOMPATIBLE_UNSUPPORTED_PLATFORM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "O", function() { return INCOMPATIBLE_NON_RESTARTLESS_ADDON; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "M", function() { return INCOMPATIBLE_FIREFOX_FENIX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "L", function() { return INCOMPATIBLE_ANDROID_UNSUPPORTED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Qb", function() { return TRACKING_TYPE_EXTENSION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Sb", function() { return TRACKING_TYPE_STATIC_THEME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Rb", function() { return TRACKING_TYPE_INVALID; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Zb", function() { return VIEW_CONTEXT_EXPLORE; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "yb", function() { return SEARCH_SORT_POPULAR; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "zb", function() { return SEARCH_SORT_RECOMMENDED; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "qb", function() { return OS_ALL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ub", function() { return OS_WINDOWS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tb", function() { return OS_MAC; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sb", function() { return OS_LINUX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rb", function() { return OS_ANDROID; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return CLEAR_ERROR; });
/* unused harmony export FEATURED_GET */
/* unused harmony export FEATURED_LOADED */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Ab", function() { return SET_AUTH_TOKEN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Bb", function() { return SET_CLIENT_APP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Db", function() { return SET_ERROR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Eb", function() { return SET_ERROR_MESSAGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Fb", function() { return SET_LANG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Gb", function() { return SET_REQUEST_ID; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Hb", function() { return SET_USER_AGENT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Ib", function() { return SET_VIEW_CONTEXT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gb", function() { return INSTALL_EVENT_LIST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mb", function() { return INSTALL_STATE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Jb", function() { return START_DOWNLOAD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return DOWNLOAD_PROGRESS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bb", function() { return INSTALL_COMPLETE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Wb", function() { return UNINSTALL_COMPLETE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fb", function() { return INSTALL_ERROR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return ENABLE_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "W", function() { return INSTALL_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Y", function() { return INSTALL_CANCELLED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cb", function() { return INSTALL_DOWNLOAD_FAILED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "jb", function() { return INSTALL_STARTED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Vb", function() { return UNINSTALL_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return ENABLE_EXTENSION_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return ENABLE_THEME_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hb", function() { return INSTALL_EXTENSION_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "nb", function() { return INSTALL_THEME_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Z", function() { return INSTALL_CANCELLED_EXTENSION_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ab", function() { return INSTALL_CANCELLED_THEME_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "db", function() { return INSTALL_DOWNLOAD_FAILED_EXTENSION_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eb", function() { return INSTALL_DOWNLOAD_FAILED_THEME_CATEGORY; });
/* unused harmony export DISCO_NAVIGATION_CATEGORY */
/* unused harmony export DISCO_NAVIGATION_ACTION */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "kb", function() { return INSTALL_STARTED_EXTENSION_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lb", function() { return INSTALL_STARTED_THEME_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Xb", function() { return UNINSTALL_EXTENSION_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Yb", function() { return UNINSTALL_THEME_CATEGORY; });
/* unused harmony export CLICK_CATEGORY */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Ob", function() { return SURVEY_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Lb", function() { return SURVEY_ACTION_DISMISSED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Mb", function() { return SURVEY_ACTION_SHOWN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Nb", function() { return SURVEY_ACTION_VISITED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Cb", function() { return SET_ENABLE_NOT_AVAILABLE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "J", function() { return GLOBAL_EVENT_STATUS_MAP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pb", function() { return ON_OPERATION_CANCELLED_EVENT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I", function() { return GLOBAL_EVENTS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "E", function() { return ERROR_UNKNOWN; });
/* unused harmony export API_ERROR_DECODING_SIGNATURE */
/* unused harmony export API_ERROR_INVALID_HEADER */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return API_ERROR_SIGNATURE_EXPIRED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C", function() { return ERROR_ADDON_DISABLED_BY_DEV; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return ERROR_ADDON_DISABLED_BY_ADMIN; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Pb", function() { return THEMES_REVIEW; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "vb", function() { return RATINGS_MODERATE; });
/* unused harmony export USERS_EDIT */
/* unused harmony export ADMIN_TOOLS */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return ALL_SUPER_POWERS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "wb", function() { return REVIEWER_TOOLS_VIEW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return ADDONS_RECOMMENDED_REVIEW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Kb", function() { return STATIC_THEMES_REVIEW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "xb", function() { return RTL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ob", function() { return LTR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return AMO_REQUEST_ID_HEADER; });
...
if(permissions.includes(core_constants__WEBPACK_IMPORTED_MODULE_16__[/* ALL_SUPER_POWERS */ "l"])){return!0}// Match exact permissions.
...
function setError(){var _ref=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},error=_ref.error,id=_ref.id;if(!id){throw new Error("id cannot be empty")}if(!error){throw new Error("error cannot be empty")}return{type:constants["Db" /* SET_ERROR */],payload:{error:error,id:id}}}function setErrorMessage(){var _ref2=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},message=_ref2.message,id=_ref2.id;if(!id){throw new Error("id cannot be empty")}if(!message){throw new Error("message cannot be empty")}return{type:constants["Eb" /* SET_ERROR_MESSAGE */],payload:{id:id,message:message}}}function clearError(id){if(!id){throw new Error("id cannot be empty")}return{type:constants["p" /* CLEAR_ERROR */],payload:{id:id}}}
// EXTERNAL MODULE: ./src/core/logger.js
var logger = __webpack_require__(18);
...
var _Object$freeze;function _templateObject(){var data=_taggedTemplateLiteral(["A version with id ","\n          has a file with an unknown platform: ",""]);_templateObject=function(){return data};return data}function _taggedTemplateLiteral(strings,raw){if(!raw){raw=strings.slice(0)}return Object.freeze(Object.defineProperties(strings,{raw:{value:Object.freeze(raw)}}))}function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function _objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){ownKeys(Object(source),!0).forEach(function(key){_defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0})}else{obj[key]=value}return obj}var FETCH_VERSION="FETCH_VERSION";var FETCH_VERSIONS="FETCH_VERSIONS";var LOAD_VERSIONS="LOAD_VERSIONS";var initialState={byId:{},bySlug:{}};var defaultPlatformFiles=Object.freeze((_Object$freeze={},_defineProperty(_Object$freeze,core_constants__WEBPACK_IMPORTED_MODULE_26__[/* OS_ALL */ "qb"],void 0),_defineProperty(_Object$freeze,core_constants__WEBPACK_IMPORTED_MODULE_26__[/* OS_ANDROID */ "rb"],void 0),_defineProperty(_Object$freeze,core_constants__WEBPACK_IMPORTED_MODULE_26__[/* OS_LINUX */ "sb"],void 0),_defineProperty(_Object$freeze,core_constants__WEBPACK_IMPORTED_MODULE_26__[/* OS_MAC */ "tb"],void 0),_defineProperty(_Object$freeze,core_constants__WEBPACK_IMPORTED_MODULE_26__[/* OS_WINDOWS */ "ub"],void 0),_Object$freeze));var createPlatformFiles=function(version){var platformFiles=_objectSpread({},defaultPlatformFiles);if(version&&0<version.files.length){version.files.forEach(function(file){// eslint-disable-next-line no-prototype-builtins
...
language=langMap.hasOwnProperty(language)?langMap[language]:defaultLang}return language}function isRtlLang(lang){var language=sanitizeLanguage(lang);return rtlLangs.includes(language)}function getDirection(lang){return isRtlLang(lang)?core_constants__WEBPACK_IMPORTED_MODULE_34__[/* RTL */ "xb"]:core_constants__WEBPACK_IMPORTED_MODULE_34__[/* LTR */ "ob"]}function qualityCmp(a,b){if(a.quality===b.quality){return 0}if(a.quality<b.quality){return 1}return-1}/*
...
_log.info("Event received",{type:type,id:guid,needsRestart:needsRestart});if(type===core_constants__WEBPACK_IMPORTED_MODULE_10__[/* ON_OPERATION_CANCELLED_EVENT */ "pb"]){// We need to retrieve the correct status for this add-on.
...
var initialApiState={clientApp:null,lang:null,requestId:null,token:null,userAgent:null,userAgentInfo:{browser:{},os:{}}};function api(){var state=0<arguments.length&&arguments[0]!==void 0?arguments[0]:initialApiState,action=1<arguments.length?arguments[1]:void 0;switch(action.type){case core_constants__WEBPACK_IMPORTED_MODULE_9__[/* SET_AUTH_TOKEN */ "Ab"]:return _objectSpread({},state,{token:action.payload.token});case core_constants__WEBPACK_IMPORTED_MODULE_9__[/* SET_LANG */ "Fb"]:return _objectSpread({},state,{lang:action.payload.lang});case core_constants__WEBPACK_IMPORTED_MODULE_9__[/* SET_CLIENT_APP */ "Bb"]:return _objectSpread({},state,{clientApp:action.payload.clientApp});case core_constants__WEBPACK_IMPORTED_MODULE_9__[/* SET_REQUEST_ID */ "Gb"]:return _objectSpread({},state,{requestId:action.payload.requestId});case core_constants__WEBPACK_IMPORTED_MODULE_9__[/* SET_USER_AGENT */ "Hb"]:{var _UAParser=ua_parser_js__WEBPACK_IMPORTED_MODULE_7___default()(action.payload.userAgent),browser=_UAParser.browser,os=_UAParser.os;return _objectSpread({},state,{userAgent:action.payload.userAgent,userAgentInfo:{browser:browser,os:os}})}case amo_reducers_users__WEBPACK_IMPORTED_MODULE_8__[/* LOG_OUT_USER */ "a"]:return _objectSpread({},state,{token:null});default:return state;}}
 ...
 * absolute path.
 */var normalizeFileNameId=function(filename){var fileId=filename;if(!fileId.startsWith("src")){fileId=fileId.replace(/^.*src/,"src")}return fileId};var getDisplayName=function(component){return component.displayName||component.name||"Component"};var addQueryParamsToHistory=function(_ref7){var history=_ref7.history,_ref7$_parse=_ref7._parse,_parse=void 0===_ref7$_parse?lib["parse"]:_ref7$_parse,_ref7$_stringify=_ref7._stringify,_stringify=void 0===_ref7$_stringify?lib["stringify"]:_ref7$_stringify;return Object(es["a" /* default */])(history,_stringify,_parse)};var userAgentOSToPlatform=(_userAgentOSToPlatfor={},_defineProperty(_userAgentOSToPlatfor,api["b" /* USER_AGENT_OS_ANDROID */].toLowerCase(),constants["rb" /* OS_ANDROID */]),_defineProperty(_userAgentOSToPlatfor,api["x" /* USER_AGENT_OS_MAC */].toLowerCase(),constants["tb" /* OS_MAC */]),_defineProperty(_userAgentOSToPlatfor,api["z" /* USER_AGENT_OS_WINDOWS */].toLowerCase(),constants["ub" /* OS_WINDOWS */]),_defineProperty(_userAgentOSToPlatfor,api["c" /* USER_AGENT_OS_BSD_DRAGONFLY */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["d" /* USER_AGENT_OS_BSD_FREEBSD */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["e" /* USER_AGENT_OS_BSD_NETBSD */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["f" /* USER_AGENT_OS_BSD_OPENBSD */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["g" /* USER_AGENT_OS_BSD_PC */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["i" /* USER_AGENT_OS_LINUX */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["j" /* USER_AGENT_OS_LINUX_ARCH */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["k" /* USER_AGENT_OS_LINUX_CENTOS */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["l" /* USER_AGENT_OS_LINUX_DEBIAN */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["m" /* USER_AGENT_OS_LINUX_FEDORA */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["n" /* USER_AGENT_OS_LINUX_GENTOO */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["o" /* USER_AGENT_OS_LINUX_GNU */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["p" /* USER_AGENT_OS_LINUX_LINPUS */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["q" /* USER_AGENT_OS_LINUX_PC */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["r" /* USER_AGENT_OS_LINUX_REDHAT */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["s" /* USER_AGENT_OS_LINUX_SLACKWARE */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["t" /* USER_AGENT_OS_LINUX_SUSE */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["u" /* USER_AGENT_OS_LINUX_UBUNTU */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["v" /* USER_AGENT_OS_LINUX_VECTOR */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["w" /* USER_AGENT_OS_LINUX_ZENWALK */].toLowerCase(),constants["sb" /* OS_LINUX */]),_defineProperty(_userAgentOSToPlatfor,api["y" /* USER_AGENT_OS_UNIX */].toLowerCase(),constants["sb" /* OS_LINUX */]),_userAgentOSToPlatfor);var findFileForPlatform=function(_ref8){var userAgentInfo=_ref8.userAgentInfo,platformFiles=_ref8.platformFiles;browser_default()(userAgentInfo,"userAgentInfo is required");browser_default()(platformFiles,"platformFiles is required");var agentOsName=userAgentInfo.os.name&&userAgentInfo.os.name.toLowerCase(),platform=agentOsName&&userAgentOSToPlatform[agentOsName];return platform&&platformFiles[platform]||platformFiles[constants["qb" /* OS_ALL */]]};var getCategoryResultsQuery=function(_ref9){var addonType=_ref9.addonType,slug=_ref9.slug;return Object(searchUtils["b" /* convertFiltersToQueryParams */])({addonType:addonType,category:slug,sort:"".concat(constants["zb" /* SEARCH_SORT_RECOMMENDED */],",").concat(constants["yb" /* SEARCH_SORT_POPULAR */])})};
...
this._ga("send",_objectSpread({hitType:"pageview"},data));this.log("pageView",JSON.stringify(data))}/*
   ...
   * calls to GA.
   */},{key:"setDimension",value:function setDimension(_ref4){var dimension=_ref4.dimension,value=_ref4.value;browser_default()(dimension,"A dimension is required");browser_default()(value,"A value is required");this._ga("set",dimension,value);this.log("set",{dimension:dimension,value:value})}}]);return Tracking}();function getAddonTypeForTracking(type){var _ADDON_TYPE_DICT$ADDO;return(_ADDON_TYPE_DICT$ADDO={},_defineProperty(_ADDON_TYPE_DICT$ADDO,constants["g" /* ADDON_TYPE_DICT */],constants["Qb" /* TRACKING_TYPE_EXTENSION */]),_defineProperty(_ADDON_TYPE_DICT$ADDO,constants["h" /* ADDON_TYPE_EXTENSION */],constants["Qb" /* TRACKING_TYPE_EXTENSION */]),_defineProperty(_ADDON_TYPE_DICT$ADDO,constants["i" /* ADDON_TYPE_LANG */],constants["Qb" /* TRACKING_TYPE_EXTENSION */]),_defineProperty(_ADDON_TYPE_DICT$ADDO,constants["j" /* ADDON_TYPE_OPENSEARCH */],constants["Qb" /* TRACKING_TYPE_EXTENSION */]),_defineProperty(_ADDON_TYPE_DICT$ADDO,constants["k" /* ADDON_TYPE_STATIC_THEME */],constants["Sb" /* TRACKING_TYPE_STATIC_THEME */]),_ADDON_TYPE_DICT$ADDO)[type]||constants["Rb" /* TRACKING_TYPE_INVALID */]}var getAddonEventCategory=function(type,installAction){var isThemeType=constants["k" /* ADDON_TYPE_STATIC_THEME */]===type;switch(installAction){case constants["x" /* ENABLE_ACTION */]:return isThemeType?constants["z" /* ENABLE_THEME_CATEGORY */]:constants["y" /* ENABLE_EXTENSION_CATEGORY */];case constants["Y" /* INSTALL_CANCELLED_ACTION */]:return isThemeType?constants["ab" /* INSTALL_CANCELLED_THEME_CATEGORY */]:constants["Z" /* INSTALL_CANCELLED_EXTENSION_CATEGORY */];case constants["cb" /* INSTALL_DOWNLOAD_FAILED_ACTION */]:return isThemeType?constants["eb" /* INSTALL_DOWNLOAD_FAILED_THEME_CATEGORY */]:constants["db" /* INSTALL_DOWNLOAD_FAILED_EXTENSION_CATEGORY */];case constants["jb" /* INSTALL_STARTED_ACTION */]:return isThemeType?constants["lb" /* INSTALL_STARTED_THEME_CATEGORY */]:constants["kb" /* INSTALL_STARTED_EXTENSION_CATEGORY */];case constants["Vb" /* UNINSTALL_ACTION */]:return isThemeType?constants["Yb" /* UNINSTALL_THEME_CATEGORY */]:constants["Xb" /* UNINSTALL_EXTENSION_CATEGORY */];default:return isThemeType?constants["nb" /* INSTALL_THEME_CATEGORY */]:constants["hb" /* INSTALL_EXTENSION_CATEGORY */];}};/* harmony default export */ var tracking = (new tracking_Tracking);
// EXTERNAL MODULE: ./src/core/utils/url.js
...
function setInstallState(installation){return{type:constants["mb" /* INSTALL_STATE */],payload:installation}}var setInstallError=function(_ref){var guid=_ref.guid,error=_ref.error;browser_default()(guid,"guid is required");return{type:constants["fb" /* INSTALL_ERROR */],payload:{guid:guid,error:error}}};
// EXTERNAL MODULE: ./src/core/addonManager.js
var addonManager = __webpack_require__(352);
...
_log.error("could not determine whether the add-on was enabled",_context.t0);case 14:return _context.abrupt("return",!1);case 15:case"end":return _context.stop();}}},_callee,this,[[4,11]])}));return function isAddonEnabled(){return _isAddonEnabled.apply(this,arguments)}}()},{key:"setCurrentStatus",value:function setCurrentStatus(){var _this$props2=this.props,_addonManager=_this$props2._addonManager,_log=_this$props2._log,addon=_this$props2.addon,currentVersion=_this$props2.currentVersion,defaultInstallSource=_this$props2.defaultInstallSource,dispatch=_this$props2.dispatch,location=_this$props2.location,userAgentInfo=_this$props2.userAgentInfo;if(!_addonManager.hasAddonManager()){_log.info("No addon manager, cannot set add-on status");return Promise.resolve()}if(!addon){_log.debug("no addon, aborting setCurrentStatus()");return Promise.resolve()}if(!currentVersion){_log.debug("no currentVersion, aborting setCurrentStatus()");return Promise.resolve()}var guid=addon.guid,type=addon.type,platformFiles=currentVersion.platformFiles,installURL=findInstallURL({defaultInstallSource:defaultInstallSource,location:location,platformFiles:platformFiles,userAgentInfo:userAgentInfo}),payload={guid:guid,url:installURL};_log.info("Setting add-on status");return _addonManager.getAddon(guid).then(function(clientAddon){var status=_addonManager.getAddonStatus({addon:clientAddon,type:type});dispatch(setInstallState(installAddon_objectSpread({},payload,{status:status})))},function(error){_log.info(Object(common_tags_es["a" /* oneLine */])(_templateObject2(),guid,error));dispatch(setInstallState(installAddon_objectSpread({},payload,{status:constants["Tb" /* UNINSTALLED */]})))}).catch(function(error){_log.error("Caught error from addonManager: ".concat(error));// Dispatch a generic error should the success/error functions throw.
dispatch(setInstallState({guid:guid,status:constants["A" /* ERROR */],error:constants["F" /* FATAL_ERROR */]}))})}},{key:"enable",value:function enable(){var _this=this,_ref3=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{sendTrackingEvent:!0},sendTrackingEvent=_ref3.sendTrackingEvent,_this$props3=this.props,_addonManager=_this$props3._addonManager,_log=_this$props3._log,_tracking=_this$props3._tracking,dispatch=_this$props3.dispatch,addon=_this$props3.addon;if(!addon){_log.debug("no addon found, aborting enable().");return Promise.resolve()}var guid=addon.guid,type=addon.type,name=addon.name;return _addonManager.enable(guid).then(function(){if(sendTrackingEvent){_tracking.sendEvent({action:getAddonTypeForTracking(type),category:getAddonEventCategory(type,constants["x" /* ENABLE_ACTION */]),label:name})}if(!_addonManager.hasPermissionPromptsEnabled()){_this.showInfo()}}).catch(function(err){if(err&&err.message===constants["Cb" /* SET_ENABLE_NOT_AVAILABLE */]){_log.info("addon.setEnabled not available. Unable to enable ".concat(guid))}else{// eslint-disable-next-line amo/only-log-strings
_log.error("Error while trying to enable ".concat(guid,":"),err);dispatch(setInstallState({guid:guid,status:constants["A" /* ERROR */],error:constants["F" /* FATAL_ERROR */]}))}})}},{key:"install",value:function install(){var _this2=this,_this$props4=this.props,_addonManager=_this$props4._addonManager,_log=_this$props4._log,_tracking=_this$props4._tracking,addon=_this$props4.addon,currentVersion=_this$props4.currentVersion,defaultInstallSource=_this$props4.defaultInstallSource,dispatch=_this$props4.dispatch,location=_this$props4.location,userAgentInfo=_this$props4.userAgentInfo;if(!addon){_log.debug("no addon found, aborting install().");return Promise.resolve()}if(!currentVersion){_log.debug("no currentVersion found, aborting install().");return Promise.resolve()}var guid=addon.guid,name=addon.name,type=addon.type,platformFiles=currentVersion.platformFiles;return new Promise(function(resolve){dispatch({type:constants["Jb" /* START_DOWNLOAD */],payload:{guid:guid}});_tracking.sendEvent({action:getAddonTypeForTracking(type),category:getAddonEventCategory(type,constants["jb" /* INSTALL_STARTED_ACTION */]),label:name});var installURL=findInstallURL({defaultInstallSource:defaultInstallSource,location:location,platformFiles:platformFiles,userAgentInfo:userAgentInfo});resolve(installURL)}).then(function(installURL){if(!installURL){throw new Error("installURL is invalid (empty or undefined)")}var hash=getFileHash({addon:addon,installURL:installURL,version:currentVersion});return _addonManager.install(installURL||"",makeProgressHandler({_tracking:_tracking,dispatch:dispatch,guid:guid,name:name,type:type}),{defaultInstallSource:defaultInstallSource,hash:hash})}).then(function(){_tracking.sendEvent({action:getAddonTypeForTracking(type),category:getAddonEventCategory(type,constants["W" /* INSTALL_ACTION */]),label:name});if(!_addonManager.hasPermissionPromptsEnabled()){_this2.showInfo()}}).catch(function(error){_log.error("Install error: ".concat(error));dispatch(setInstallError({guid:guid,error:constants["G" /* FATAL_INSTALL_ERROR */]}))})}},{key:"showInfo",value:function showInfo(){var _this$props5=this.props,addon=_this$props5.addon,dispatch=_this$props5.dispatch;browser_default()(addon,"addon is required");dispatch(Object(infoDialog["b" /* showInfoDialog */])({addonName:addon.name,imageURL:Object(imageUtils["a" /* getAddonIconUrl */])(addon)}))}},{key:"uninstall",value:function uninstall(_ref4){var guid=_ref4.guid,name=_ref4.name,type=_ref4.type,_this$props6=this.props,_addonManager=_this$props6._addonManager,_log=_this$props6._log,_tracking=_this$props6._tracking,dispatch=_this$props6.dispatch;dispatch(setInstallState({guid:guid,status:constants["Ub" /* UNINSTALLING */]}));var action=getAddonTypeForTracking(type);return _addonManager.uninstall(guid).then(function(){_tracking.sendEvent({action:action,category:getAddonEventCategory(type,constants["Vb" /* UNINSTALL_ACTION */]),label:name})}).catch(function(error){_log.error("Uninstall error: ".concat(error));dispatch(setInstallError({guid:guid,error:constants["H" /* FATAL_UNINSTALL_ERROR */]}))})}},{key:"render",value:function render(){var _this3=this,_this$props7=this.props,WrappedComponent=_this$props7.WrappedComponent,_addonManager=_this$props7._addonManager,passThroughProps=_objectWithoutProperties(_this$props7,["WrappedComponent","_addonManager"]),injectedProps={enable:function enable(){return _this3.enable.apply(_this3,arguments)},// We pass a `boolean` value here, not the function.
...
if("Firefox"===browser.name&&"iOS"===os.name){return{compatible:!1,reason:constants["N" /* INCOMPATIBLE_FIREFOX_FOR_IOS */]}}if(addon.type===constants["j" /* ADDON_TYPE_OPENSEARCH */]&&!(_window.external&&"AddSearchProvider"in _window.external)){return{compatible:!1,reason:constants["Q" /* INCOMPATIBLE_NO_OPENSEARCH */]}}if(!isFirefox({userAgentInfo:userAgentInfo})){return{compatible:!1,reason:constants["P" /* INCOMPATIBLE_NOT_FIREFOX */]}}// Fenix does not support add-ons (yet?).
// See: https://github.com/mozilla-mobile/fenix/issues/1134
// See also: https://github.com/mozilla/addons-frontend/issues/7963
if(isFenix(userAgentInfo)){return{compatible:!1,reason:constants["M" /* INCOMPATIBLE_FIREFOX_FENIX */]}}// At this point we need a currentVersion in order for an extension to be
// marked as compatible.
if(!currentVersion){return{compatible:!1,reason:constants["T" /* INCOMPATIBLE_UNSUPPORTED_PLATFORM */]}}// For Android, we need to check that compatibility info exists for `android`.
if(os.name===api["b" /* USER_AGENT_OS_ANDROID */]&&!currentVersion.compatibility[constants["q" /* CLIENT_APP_ANDROID */]]){return{compatible:!1,reason:constants["L" /* INCOMPATIBLE_ANDROID_UNSUPPORTED */]}}// Do version checks, if this add-on has minimum or maximum version
// requirements.
...
return{compatible:!1,reason:constants["S" /* INCOMPATIBLE_UNDER_MIN_VERSION */]}}// Even if an extension's version is marked compatible,
...
//# sourceMappingURL=main.dfc2925365281db6996b.bundle.js.map